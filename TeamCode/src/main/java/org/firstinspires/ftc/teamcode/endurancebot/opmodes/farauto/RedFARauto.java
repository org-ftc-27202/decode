...
public final class RedFARauto extends OpMode {
    ...
    private final Pose loadingZone= new Pose(8.0, 12.0, Math.toRadians(180)).mirror();
    ...
    public void buildPaths() {
        ...
        driveToSpike1Collect = follower
                ...
                .setLinearHeadingInterpolation(spike1Control.getHeading(), spike1End.getHeading())
                .build();
        ...
        driveToThirdLaunch = follower
                ...
                .setLinearHeadingInterpolation(loadingZone.getHeading(), Math.toRadians(0))
                .build();
