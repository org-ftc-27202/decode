...
//        public double parYTicks = -24; // y position of the parallel encoder (in tick units)
//        public double perpXTicks = -24; // x position of the perpendicular encoder (in tick units)
    }
...
//        driver.setOffsets(mmPerTick * PARAMS.parYTicks, mmPerTick * PARAMS.perpXTicks, DistanceUnit.MM);
        driver.setOffsets(24.0, -24.0, DistanceUnit.MM);
