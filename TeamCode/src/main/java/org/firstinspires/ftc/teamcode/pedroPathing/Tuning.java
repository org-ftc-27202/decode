...
public class Tuning extends SelectableOpMode {
    ...
    /** This creates a full onStop of the robot by setting the drive motors to run at 0 power. */
...
class ForwardVelocityTuner extends OpMode {
    ...
    public void init_loop() {
        ...
        telemetryM.debug("Press B on game pad 1 to onStop.");
     ...
     * game pad 1 will onStop the OpMode. This continuously records the RECORD_NUMBER most recent
...
class LateralVelocityTuner extends OpMode {
    ...
    public void init_loop() {
        ...
        telemetryM.debug("Press B on Gamepad 1 to onStop.");
        telemetryM.update(telemetry);
    ...
    /**
     * This runs the OpMode. At any point during the running of the OpMode, pressing B on
     * game pad1 will onStop the OpMode. This continuously records the RECORD_NUMBER most recent
...
class ForwardZeroPowerAccelerationTuner extends OpMode {
    ...
    public void init_loop() {
        ...
        telemetryM.debug("Then, it will cut power from the drivetrain and roll to a onStop.");
    ...
    /**
     * This runs the OpMode. At any point during the running of the OpMode, pressing B on
     * game pad 1 will onStop the OpMode. When the robot hits the specified velocity, the robot will
 ...
 * Path the same distance back to the onStart. Rinse and repeat! This is good for testing a variety
