...
public final class TankDrive {
    ...
    public TankDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftMotors = Arrays.asList(hardwareMap.get(DcMotorEx.class, "leftFront"), hardwareMap.get(DcMotorEx.class, "leftRear"));
        rightMotors = Arrays.asList(hardwareMap.get(DcMotorEx.class, "rightFront"), hardwareMap.get(DcMotorEx.class, "rightRear"));
    ...
    public final class FollowTrajectoryAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            c.setStroke("#4CAF50");
            RRDrawing.drawRobot(c, txWorldTarget.value());

            c.setStroke("#3F51B5");
            RRDrawing.drawRobot(c, localizer.getPose());
