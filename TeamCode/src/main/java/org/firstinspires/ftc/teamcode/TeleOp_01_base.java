...
public abstract class TeleOp_01_base extends NextFTCOpMode {
    ...
    public void buildPaths() {
        Pose baseEndGamePose, loadingZonePose, gatePose, launch1Pose;
...
//            launch1Pose = new Pose(84, 20, Math.toRadians(65));  // good for auto
            ...
            launch1Pose = new Pose(86, 74, Math.toRadians(48));  // works with auto as well
        }
        ...
        driveToGate = PedroComponent.follower().pathBuilder()
                ...
                .setLinearHeadingInterpolation(PedroComponent.follower().getHeading(), gatePose.getHeading())
                .build();
    ...
    public void onUpdate() {
        ...
        telemetry.addLine("dpadDown+: a=Base | x=Relocalize | y=GetMotif");
        telemetry.update();
    }
}
